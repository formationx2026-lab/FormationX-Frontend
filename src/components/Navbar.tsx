...
const Navbar = () => {
  ...
  return (
    <motion.header
      // Replaced var(--border-soft) with rgba(255, 255, 255, 0.1)
      className="relative bg-black/70 backdrop-blur-xl border-b border-[rgba(255,255,255,0.1)] sticky top-0 z-50"
      initial={{ y: -100 }}
      animate={{ y: 0 }}
      ...
      <motion.div
        ...
        animate={{
          background: [
            ...
            "linear-gradient(90deg, rgba(6, 182, 212, 0.15), transparent, rgba(6, 182, 212, 0.15))",
      ...
      <nav className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              ...
              >
                ...
                <motion.div
                  // Replaced var(--border-soft)
                  className="absolute inset-0 border border-[rgba(255,255,255,0.1)] rounded-lg -z-10"
                  // Replaced var(--primary) with #06b6d4
        ...
        <AnimatePresence>
          {open && (
            <motion.div
              // Replaced var(--border-soft)
              className="md:hidden absolute top-full left-0 right-0 bg-black/95 backdrop-blur-xl border-b border-[rgba(255,255,255,0.1)] overflow-hidden"
            ...
            >
              <div className="px-4 py-6 space-y-4">
                ...
                <motion.div
                  // Replaced var(--border-soft)
                  className="pt-3 border-t border-[rgba(255,255,255,0.1)]"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  transition={{ delay: navLinks.length * 0.1 }}
                >
                  ...
                  {featureItems.map((item, index) => (
                    ...
                    >
                      <Link
                        ...
                        style={{ color: "#06b6d4" }} // Replaced var(--primary) with #06b6d4
                      >
                        <motion.span
                          whileHover={{ scale: 1.05 }}
